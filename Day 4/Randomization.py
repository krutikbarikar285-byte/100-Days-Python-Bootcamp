...
#Here the random function randoms the number between 0.0<=N<1.0
# and below is another function called uniform that randoms between two numbers includingg both the number 
